...
$nowtime= date('Y-m-d H:i:s', $nowtime); 
 ...
 $sql="insert into ocl (  mid , cardid ,  lastdate     )  values('$mid','$userscan','$nowtime')  ";
 	mysqli_query($link,$sql);
		...
		$data = array();
		$data["cardid"] = $userscan;  //alipay用户名
		...
		$user_limited_daliy = $data['user_limited_daliy']; //用户当天限制(屈臣�?的额度（已计算）
...
if (  $isactive==1 )   //ֱ�ӹ��˵���32λ���û�id
{
  ...
  header("Location:../recycle/index.php");  //����������qrֵ����
			 ...
			 header("Location:own_confirm.php");  //����������qrֵ����	 
			 }
	
}
else{
	
	  header("Location:http://127.0.0.1/tjt/index.php");  //����������qrֵ����
