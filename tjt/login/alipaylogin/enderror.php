...
border-radius:10%;
    ...
    body {
	background-image: url(background/Ali09Bc.jpg);
...
<body>
    ...
    <div align="left"  ><a href="../../index.php" class="btn2" style="margin-top:520px;margin-left:450px;position:absolute">結束回收</a> </div>
  
<div align="center" style="margin-top:480px;margin-left:0px;color:#fff;font-size:20px;font-weight:bold">错误号(Error no).<?php 
...
// $result=mysqli_query($link,$sql);
// $result=mysqli_fetch_array($result);
// $alipayid=$result['transactionid'];
 // $auth_url = 'http://hk04aswirvmuat.eastasia.cloudapp.azure.com/qcsqcs/urlget/alp.php?transactionid='.$alipayid.'&qcserrorcode='.$str  ;
// $ch = curl_init();
